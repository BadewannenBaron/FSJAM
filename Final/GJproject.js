...
if (erg== 0){direc = "left";}
if (erg== 1){direc = "right";}
if (erg== 2){direc = "top";}
if (erg== 3){direc = "bottom";}
return erg;
}
...
function isOutsideBoundary(entity){
  ...
  // newX = (newX - newX % 100) / 100
  // newY = (newY - newY % 100) / 100

  // console.log(grid[(newX - newX % 100) / 100][(newY - newY % 100) / 100] == 1)
